...
export class ChartEchartComponent implements OnInit {
	...
	ngOnInit() {
		...
		this.chartOptions = {
			...
			legend: {
                data: ['Bin A', 'Bin B', 'Bin C', 'Bin D', 'Bin E'],
                textStyle:{
                    color: "#C2C2C2"
                }
			},
		...
		this.pieOptions = {
			...
			legend: {
				orient: 'vertical',
				left: 'left',
                data: ['Bin C', 'Bin A', 'Bin B', 'Bin D', 'Bin E'],
                textStyle: {
                    color: "#C2C2C2"
                }
			},
			series: [
				{
					...
					center: ['50%', '60%'],
					data: [
						{ value: 135, name: 'Bin C' },
						{ value: 310, name: 'Bin A' },
						{ value: 234, name: 'Bin B' },
						{ value: 335, name: 'Bin D' },
						{ value: 1548, name: 'Bin E' }
					],
					itemStyle: {
						emphasis: {
							shadowBlur: 10,
