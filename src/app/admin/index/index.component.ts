...
export class IndexComponent implements OnInit, OnDestroy {
    ...
    constructor(private activatedRoute: ActivatedRoute, public poubelleService: PoubelleService, private sidebarService: SidebarService, private cdr: ChangeDetectorRef, private toastr: ToastrService) {
    ...
    showToastr() {
        this.toastr.info('Hello, welcome to Smart Waste Mgmt Platform.', undefined, {
            closeButton: true,
