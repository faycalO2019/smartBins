...
import { HometextComponent } from '../admin/hometext/hometext.component';

@NgModule({
	declarations: [PageLoginComponent, HometextComponent,AuthenticationComponent, PageRegisterComponent, PageLockscreenComponent, PageForgotPasswordComponent, PageNotFoundComponent, PageForbiddonErrorComponent, PageIsErrorComponent, PageTryLaterComponent],
	imports: [
		CommonModule,
		routing,
		PagesModule,
